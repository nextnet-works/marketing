...
export const Footer = () => {
  return (
    <footer className="flex md:flex-row flex-col justify-center items-center gap-8 md:gap-4 mx-auto p-4 max-w-7xl space-between">
      <div className="flex flex-1 justify-start items-center">
        <Logo className="w-[133px] max-w-[90%] h-6" />
      </div>
